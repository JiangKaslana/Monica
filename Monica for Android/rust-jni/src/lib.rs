...
use jni::JNIEnv;
use monica_password_list_core::{
    project_password_list, PasswordListRecord, ProjectionOptions,
};

const RUST_CORE_VERSION: &str = "monica-password-list-core/0.1.0-arm64-test";
...
pub extern "system" fn Java_takagi_ru_monica_rustcore_RustPasswordListCore_nativeSelfTest(
    ...
    let rows = vec![
        PasswordListRecord {
            ...
            notes_preview: "Rust JNI smoke row".to_owned(),
